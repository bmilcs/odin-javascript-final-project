...
//   const { data: movieDetailsData, error: movieDetailsError } = useFetch(movieDetailsURL);
...
//                 .backdrop_path:
//                 <img src={`https://image.tmdb.org/t/p/original/${special.backdrop_path}`} />
//                 .poster_path:
//                 <img src={`https://image.tmdb.org/t/p/original/${special.poster_path}`} />
//               </div>
//             );
//           })}
//       </div>
